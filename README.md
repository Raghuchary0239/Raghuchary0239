...
1: Netflix user viewing pattern analysis (Data preprocessing, Visualization Matplotlib, Seaborn and Machine Learing Models).
    project 
    project link:   http://localhost:8888/notebooks/netflix-movies-tv-shows-eda-project-Copy1.ipynb
...
## Tech
Python, SQL, 
libraries : Pandas, Numpy, Matplotlib, Scikit-Learning, 
...
Shriram Life Insurance Company Limited, Hyderabad, Telangana
  ...
  *Understood the role of Data in AI and ML.
  ...
  🌐 LINK : https://www.credly.com/users/raghavendar-chary-kanukanti
